        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box mb-0 d-sm-flex align-items-center justify-content-between">
                    <h2 class="mb-sm-0 m-0 font-size-18 page-title">Progress Unduhan Rapor</h2>
                    <div class="page-title-right">
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript: void(0);">Home</a></li>
                            <li class="breadcrumb-item">Imports</li>
                            <li class="breadcrumb-item">Progress Unduhan Rapor</li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="col-xl-8 col-sm-12">
                            ...
                            <form action="{{ route('pur.excel') }}" method="POST" enctype="multipart/form-data" class="needs-validation">
                                @csrf
